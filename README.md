...
| **$|z| = sqrt(a^2 + b^2) > 2$** | `zx * zx + zy * zy > 4.0` | in such format, I don't need the $sqrt()$ as anything bigger than $4$ will have the square root bigger than $2$, as $√4 = 2$ |
